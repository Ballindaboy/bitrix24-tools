...
### Вариант A: Claude Cowork (без терминала)

1. Открой https://claude.ai/ → вкладка **Cowork**
2. Нажми на папку слева и выбери `~/Projects/bitrix24-tools`
3. Спрашивай:
   - "Какие сделки сейчас в работе?"
   - "Покажи мои задачи на эту неделю"
   - "Найди всю активность по клиенту X"
...
Работает так же, но в терминале.
